...
\begin{table}[H]
    ...
    \hline
    & & \textbf{Python 3.12} & \small{Najnowsza wersja języka Python z zaawansowanymi funkcjami. Wykorzystywane biblioteki: \texttt{openai, asyncio, tiktoken, scipy, gitpython}} \\
    \hline
 \end{tabular}
\end{adjustwidth}
